        ...
        <div>
            <Container>
                <div className="d-flex">
                    ...
                    <div className="mr-auto p-2">
                        <Link to="/visualizarcliente" className="btn btn-outline-primary btn-sm">Lista de clientes</Link>
                        <Link to={"/cliente/" + id} className="btn btn-outline-primary btn-sm m-1">Consultar</Link>
                    </div>
                </div>
                ...
                <Form className="p-2" onSubmit={edtCliente}>
                    ...
                    {status.formSave ?
                        <Button type="submit" outline color="warning" className="m-1" disabled>Salvando... <Spinner color="warning" /></Button> :
