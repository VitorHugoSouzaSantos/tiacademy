        ...
        <div>
            <Container>
                <div className="d-flex">
                    ...
                    <div className="mr-auto p-2">
                        <Link to="/visualizarservico" className="btn btn-outline-primary btn-sm m-1">Lista de serviços</Link>
                        <Link to={"/servico/" + id} className="btn btn-outline-primary btn-sm m-1">Consultar</Link>
                    </div>
                </div>
